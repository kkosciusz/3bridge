...
@pytest.mark.parametrize(
    ...
    [
        ...
        (open_1_clubs_natural, '87.AJ1087.QJ3.KQ10', False),  # not enough cards
        ...
        (open_1_clubs_balanced, 'KQ87.QJ87.Q876.J', False),  # too little points
        ...
        (open_1_clubs_strong, 'AKQJ.AKQJ.9876.K', False),
        (open_1_clubs_strong, 'AKQ8.AKJ9.9876.8', False),
        (open_1_diamonds, '87.AJ10.KQ1075.QJ3', True),
        (open_1_diamonds, '87.AJ1087.KQ10.QJ3', False),  # not enough cards
        ...
        (open_1_hearts, '87.KQ108.AJ87.QJ3', False),  # not enough cards
        ...
        (open_1_spades, 'KQ108.A87.J87.QJ3', False),  # not enough cards
        ...
        (open_1_notrump, 'KQ87.KQ87.KJ76.Q9', False),  # too few clubs
        (open_1_notrump, 'KQ87.KQ87.Q9.KJ76', False),  # too few diamonds
        (open_1_notrump, 'KQ87.Q9.KQ87.KJ76', False),  # too few hearts
        (open_1_notrump, 'Q9.KQ87.KQ87.KJ76', False),  # too few spades
    ],
)
